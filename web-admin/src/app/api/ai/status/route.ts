...
const providers = [
  ...
  { id: 'gemini', name: 'Google Gemini', env: 'GEMINI_API_KEY', role: 'Google Workspace, múltimodalidade, Drive, Gmail, Agenda e Docs.' },
  { id: 'anthropic', name: 'Claude', env: 'ANTHROPIC_API_KEY', role: 'Análise longa, escrita profissional, código e tarefas complexas.' },
  ...
  { id: 'mistral', name: 'Mistral', env: 'MISTRAL_API_KEY', role: 'Modelos eficientes para automações e texto operacional.' },
