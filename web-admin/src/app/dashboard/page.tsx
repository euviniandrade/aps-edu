...
export default function DashboardPage() {
  ...
  const loadBriefing = async (dashData: any) => {
    ...
    try {
      ...
      const prompt = `Você é IA da Educação, assistente do Departamento de Educação - APS.
        ...
        <div className="mb-5 animate-fade-in-up rounded-2xl p-4 flex items-start gap-3"
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-1">
              <p className="text-xs font-bold" style={{ color: '#FDC347' }}>☀️ Briefing do dia · IA da Educação</p>
