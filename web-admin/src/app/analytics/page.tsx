...
Seja direto, use dados, máximo 4 linhas no total.`
  ...
  const radarActions = [
    ...
    },
    {
      ...
      metric: 'Segunda 9h',
      detail: 'Use a IA da Educação para gerar resumo de riscos, avanços e decisões recomendadas.',
      color: '#F8A303',
    },
  ]
      ...
      <div className="mb-5 rounded-2xl p-5 animate-fade-in-up"
        ...
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            ...
            <p className="text-xs" style={{ color: 'rgba(255,255,255,0.3)' }}>Gerado por IA da Educação com base nos dados atuais</p>
          </div>
        </div>
        {aiLoading ? (
          <div className="flex items-center gap-3">
            ...
            <p className="text-sm" style={{ color: 'rgba(255,255,255,0.3)' }}>IA da Educação está analisando os dados...</p>
          </div>
        ) : aiPrediction ? (
