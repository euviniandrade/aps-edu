export type SuiteDomain = 'trabalho' | 'pessoas' | 'educação' | 'operação' | 'inteligencia'
...
export const suiteModules: SuiteModule[] = [
  {
    ...
    subtitle: 'Tarefas, metas, eventos, aprovações, SLA e execucao por unidade.',
    benchmark: 'Asana, Monday, ClickUp, Jira, Wrike, Smartsheet',
    color: '#0ABD78',
    maturity: 86,
    signals: ['Kanban e lista', 'Prazos e dependencias', 'Aprovações', 'Carga da equipe'],
  },
  {
    id: 'pessoas',
  ...
  },
  {
    ...
    subtitle: 'IA da Educação, analytics preditivo, automações, riscos e recomendações.',
    benchmark: 'Notion AI, Salesforce Einstein, ServiceNow, Tableau, Power BI',
    color: '#A78BFA',
    maturity: 81,
    signals: ['Resumo executivo', 'Alertas preditivos', 'Automações', 'Busca inteligente'],
  },
]
...
export const capabilityMatrix: Capability[] = [
  ...
  {
    domain: 'trabalho',
    name: 'Dependencias, SLA e aprovação',
    bestFrom: 'Jira + Monday + Wrike',
    apsImplementation: 'Fluxo de aprovação com gargalos, vencimentos, prioridade e trilha de auditoria.',
    impact: 'alto',
    status: 'prototipo',
  },
  {
  ...
  },
  {
    ...
    apsImplementation: 'Feedback continuo, gamificação, trilhas e sinais de risco de desengajamento.',
    impact: 'medio',
    status: 'ativo',
  },
  {
  ...
  },
  {
    ...
    apsImplementation: 'Solicitação, cotação, aprovação, recebimento, baixa e histórico financeiro.',
    impact: 'alto',
    status: 'planejado',
  },
  {
...
export const personalTools: PersonalTool[] = [
  ...
  {
    title: 'IA da Educação pessoal',
    description: 'Chat, criação de tarefas e organização da rotina pessoal.',
    href: '/minha-area',
    metric: 'IA',
    color: '#4A9EFF',
  },
