...
const NAV_COMMANDS = [
  ...
  { id: 'go-users',         label: 'Ir para Pessoas',       icon: 'P', path: '/pessoas',       keywords: ['usuário', 'pessoa', 'membro', 'equipe', 'relatórios'] },
  { id: 'go-units',         label: 'Ir para Unidades',      icon: 'U', path: '/units',         keywords: ['colégio', 'unidade', 'rede', 'escola'] },
  { id: 'go-analytics',     label: 'Analytics IA',          icon: 'A', path: '/analytics',     keywords: ['predição', 'forecast', 'tendência', 'indicador'] },
  { id: 'go-automacoes',    label: 'Automações IA',         icon: 'Z', path: '/automacoes',    keywords: ['automation', 'regra', 'fluxo'] },
  { id: 'go-dashboard',     label: 'Dashboard antigo',      icon: 'D', path: '/dashboard',     keywords: ['home', 'inicio', 'dashboard antigo'] },
  { id: 'go-events',        label: 'Eventos',               icon: 'E', path: '/events',        keywords: ['evento', 'agenda', 'calendário'] },
